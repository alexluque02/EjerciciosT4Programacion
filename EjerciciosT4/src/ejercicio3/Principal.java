...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Vehiculo v=new Vehiculo(200, 120, "tipo b", 200);
		Motocicleta m;
		Coche c;
		Furgoneta f;
